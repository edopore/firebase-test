...
var _pruebaFirebase = require("./pruebaFirebase");
...
googleUp.addEventListener("click", (event)=>{
    ...
    (0, _pruebaFirebase.loginGoogle)();
});
submitTask.addEventListener("click", async (event)=>{
    event.preventDefault();
    (0, _pruebaFirebase.createTask)(input.value);
    getListTasks();
});
...
logOutBtn.addEventListener("click", (event)=>{
    event.preventDefault();
    (0, _pruebaFirebase.logOut)();
});
deleteTaskBtn.addEventListener("click", (event)=>{
    event.preventDefault();
    (0, _pruebaFirebase.deleteTask)(event.target.value);
    getListTasks();
});
async function getListTasks() {
    const tasks = await (0, _pruebaFirebase.getTasks)();
    tasks.forEach((doc)=>{
        console.log(doc.data());
    });
}
(0, _auth.onAuthStateChanged)((0, _pruebaFirebase.auth), (user)=>{
    if (user !== null) {
...
},{"firebase/auth":"79vzg","./pruebaFirebase":"4YpzP"}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequired7c6")
